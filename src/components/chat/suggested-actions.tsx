...
function PureSuggestedActions({ append }: SuggestedActionsProps) {
  const suggestedActions = [
    {
      title: "About Edwin",
      label: "Get to know me & my journey",
      action: "Tell me about Edwin's background and career path as a software engineer.",
      icon: Rocket,
    ...
    {
      title: "My Projects",
      label: "Explore apps & tools I’ve built",
      action: "What projects has Edwin developed recently?",
      icon: Code,
    ...
    {
      title: "Tech Skills",
      label: "See my stack & expertise",
      action: "What technical skills and frameworks does Edwin specialize in?",
      icon: Palette,
    ...
    {
      title: "Anime & Fun Facts",
      label: "Let’s geek out together",
      action: "Tell me a cool anime reference or a random fun fact about the world.",
      icon: Film,
    ...
    },
    {
      ...
      action: "Start a casual conversation with Edwin.",
      icon: MessageCircle,
    ...
    <div className="w-full max-w-5xl mx-auto px-2">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          Tap to discover more about me and what I build.
        </p>
      </motion.div>
