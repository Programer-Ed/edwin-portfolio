...
import { GradientWheel } from "@/components/ui/gradient-wheel"
...
export default function StickyNav() {
  ...
  return (
    <div className="sticky top-[60px] z-50">
      ...
      <nav className="bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 border dark:border-white/20 rounded-full">
